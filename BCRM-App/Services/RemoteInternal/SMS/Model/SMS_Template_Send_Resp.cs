...
{
    public class SMS_Template_Send_Resp : IBCRM_Client_Resp
    {
        ...
        public SMS_Template_Send_Resp(JObject resp)
        {
            this.RawData = resp;
            ...
            try { this.TemplateRef = (String)msg["TemplateRef"]; } catch (Exception ex) { }
    ...
    public class SMS_Template_Payload
    {
